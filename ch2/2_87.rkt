...
(define p1 (make-polynomial 'x (list (list 2 1) (list 0 2)))) ; x2 + 2
(define p2 (make-polynomial 'x (list (list 2 0) (list 0 0))))
(define p3 (make-polynomial 'x (list (list 2 0) (list 0 1))))
(define p4 (make-polynomial 'x (list (list 2 1) (list 0 0))))
(=zero? p1)
(=zero? p2)
(=zero? p3)
(=zero? p4)
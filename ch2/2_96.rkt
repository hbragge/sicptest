...
(define (install-polynomial-package)
  ...
  (define (remainder-terms l1 l2)
    (let ((fact (int-factor l1 l2)))
      (cadr (div-terms (mul-terms l1 (list (make-term 0 fact))) l2))))
   ; (cadr (div-terms l1 l2)))
  
  (define (gcd-terms l1 l2)
    (if (empty? l2)
        (let ((coeff-list (map coeff l1)))
          (div-terms l1 (list (make-term 0 (apply gcd coeff-list)))))
          ;l1)
